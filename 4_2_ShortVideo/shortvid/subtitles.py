...
# 9:16 쇼츠(1080×1920): wisdom/fonts/GmarketSansTTFBold.ttf 고정
COMPOSE_SUBTITLE_FONT_FILE = "GmarketSansTTFBold.ttf"
COMPOSE_SUBTITLE_FONT_NAME = "Gmarket Sans TTF"
COMPOSE_SUBTITLE_FONT_SIZE = 12
# 하단 정렬(2): MarginV 는 아래 여백 — 값을 키울수록 자막이 위로 올라감
COMPOSE_SUBTITLE_MARGIN_V_BASE = 40
COMPOSE_SUBTITLE_MARGIN_V = COMPOSE_SUBTITLE_MARGIN_V_BASE + COMPOSE_SUBTITLE_FONT_SIZE
COMPOSE_SUBTITLE_FORCE_STYLE = (
    f"FontName={COMPOSE_SUBTITLE_FONT_NAME},FontSize={COMPOSE_SUBTITLE_FONT_SIZE},Bold=1,"
    "PrimaryColour=&H00FFFFFF,OutlineColour=&H00000000,"
    f"BorderStyle=1,Outline=3,Shadow=0,MarginV={COMPOSE_SUBTITLE_MARGIN_V},Alignment=2"
)
...
def stage_compose_font_for_work(work_dir: Path) -> Path | None:
    """FFmpeg ``fontsdir``용: wisdom 폰트를 작업 폴더 ``fonts/`` 로 복사 (드라이브 문자 없는 상대 경로)."""
