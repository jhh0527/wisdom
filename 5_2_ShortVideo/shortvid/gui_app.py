"""5_2_ShortVideo — 쇼츠(9:16) SRT·이미지·선택 MP3 합성 GUI."""
...
def main() -> None:
    ...
    root = tk.Tk()
    root.title(f"5_2_ShortVideo {__version__}")
    ...
    def apply_pipeline_defaults() -> None:
        """TTS·SRT 이미지 output / 5_2_ShortVideo/output."""
        ...
        def work() -> None:
            try:
                ...
                def ok() -> None:
                    ...
                    log_line(f"합성 완료: {fp}")
                    messagebox.showinfo("5_2_ShortVideo", f"완료\n{fp}")
                ...
                def err() -> None:
                    ...
                    status_var.set("오류")
                    log_line(tb)
                    messagebox.showerror("5_2_ShortVideo", str(e))
