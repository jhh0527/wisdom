...
echo [1_5_textToJson] PyInstaller 빌드 시작...
set "PROOT=%~dp0.."
...
set "DISTEXE=!PROOT!\dist\1_5_textToJson_gui.exe"
taskkill /F /IM 1_5_textToJson_gui.exe >nul 2>&1
...
if not exist "!DISTEXE!" (
  echo dist\1_5_textToJson_gui.exe 를 찾을 수 없습니다.
  exit /b 1
)
